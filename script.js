window.onload = function () {
	...
	// // document.getElementById("addTaskDiv").addEventListener(onmousedown, console.log("onmousedown"));
	// // document.querySelector("#addTaskDiv").addEventListener(onmousedown, console.log("onmousedown"));
	// var drag = document.querySelector("#addTaskDiv form fieldset legend");
	
	// // dragElement(document.getElementById("addTaskDiv"));
	// dragElement(drag);
